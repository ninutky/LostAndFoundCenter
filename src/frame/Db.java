...
public class Db {
   ...
   public static void insertItem(boolean check, String name, String place, Date date, String ano, String img) {
      Item item = new Item();
      String sql = "INSERT INTO item(itype, name, place, date, ano, img) values(?, ?, ?, ?, ?, ?)";

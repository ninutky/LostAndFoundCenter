...
public class DatePickerTest {
	...
	public static void main(String[] args) {
		...
		/*
		 * datePicker = new DatePicker(dateSettings); panel.add(datePicker);
		 * datePicker.setDateToToday(); datePicker.setLocale(Locale.CANADA_FRENCH);
		 * DatePickerSettings dateSettings2 = new DatePickerSettings(Locale.CHINESE);
		 * datePicker.setSettings(dateSettings2); CalendarPanel calendarPanel;
		 * calendarPanel = new CalendarPanel(dateSettings); panel.add(calendarPanel);
		 * calendarPanel.setSelectedDate(LocalDate.now());
		 * dateSettings.setLocale(Locale.CANADA_FRENCH); DatePickerSettings
		 * dateSettings2 = new DatePickerSettings(Locale.CHINESE);
